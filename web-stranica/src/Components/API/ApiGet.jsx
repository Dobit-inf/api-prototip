...
const API = () => {
  ...
  const [endpoint, setEndpoint] = useState('http://5.189.169.61:81/api/MaRadniciApi/GetRadnik/');
  ...
  return (
    <div className="api-container">
      ...
      <div className="get-sign">
        <span className="get-sign-get">GET</span>
        <span value={endpoint}  className="get-sign-api">/GetRadnik</span>
      </div>
